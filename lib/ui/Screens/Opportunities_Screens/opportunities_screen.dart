...
import 'package:y2y/ui/Screens/Opportunities_Screens/new_opportunitie_screen.dart';
import 'package:y2y/ui/Screens/Opportunities_Screens/opportunities_details_screen.dart';
...
class _OpportunitiesState extends State<Opportunities> {
  ...
  Widget build(BuildContext context) {
    final opportunities = Provider.of<NewOpportunityProvider>(context).opportunities;
