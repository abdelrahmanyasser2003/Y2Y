...
class Opportunitiesdetils extends StatefulWidget {
  final opportunitydetilsmodel opportunity;
  Opportunitiesdetils({required this.opportunity});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      CircleAvatar(
                        backgroundImage:
                            MemoryImage(widget.opportunity.imagepath),
                        radius: 45,
                      ),
                      Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(
                              widget.opportunity.opportunitytitledetils,
                              style: TextStyle(
                                  fontSize: 18,
                                  color: cornflowerblue,
